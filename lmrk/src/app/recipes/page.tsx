        ...
        {recipes.map((recipe: Record<string, unknown>) => (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-lg font-bold text-black">{typeof recipe.name === "string" ? recipe.name : ""}</h2>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
          <div className="bg-white rounded-xl shadow-2xl p-8 max-w-lg w-full relative">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-xl font-bold text-black">{typeof selected.name === "string" ? selected.name : ""}</h2>
            </div>
